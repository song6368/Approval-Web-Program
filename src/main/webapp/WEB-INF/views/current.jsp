			...
			success:function(res){
				...
				if(res.length != 0){
                	for(var i = 0; i < res.length; i++){
                		...
                		$('tbody').append('<tr><th scope="row">'+(i+1)+'</th><td>'+res[i].name+'</td><td>'+c+'</td><td>'+res[i].interview_id1+'</td><td>'+res[i].interview_id2+'</td><td>'+res[i].interview_id3+'</td></tr>');
                	}
                }
			},
			error:function(){
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                	<div class="input-group mb-3" style="width:30%; float:right; margin:1%;">
					  <input type="text" id="sear" onkeyup="enterkey()" class="form-control" placeholder="Applicant's name..." aria-label="Search" aria-describedby="basic-addon2">
